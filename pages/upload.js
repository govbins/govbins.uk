  ...
  return (
    <>
      <div className="mx-auto w-full px-4 lg:px-0 lg:w-1/3 mb-20 pt-5 lg:pt-0">
        ...
        <form action="/confirmation" data-netlify="true" name="submission">
          ...
          <FormGroup>
            <button type="submit" to="/submit" style={{ background: '#333' }} className="text-xl mt-4 text-white rounded-md p-2 inline-block">
              Send and finish
            </button>
          </FormGroup>
        </form>
